                ...
                <div class="lg:grid lg:grid-cols-2 gap-4">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="relative z-10">
                            ...
                            <h4 class="font-averta text-white font-light text-sm xs:text-lg"><?php echo $contactHeroDescription ; ?></h4>
                        </div>
                    </div>
                    <!-- Image -->
...
<section id="formInfo" class="py-10 lg:py-24 bg-white bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="mx-10">
            <div class="lg:grid lg:grid-cols-2 gap-24">
                <?php if( have_rows('contact_content') ): ?>
                    ...
                    ?>
                    <!-- Contact Form -->
                    <div class="contactPage_contact__form font-averta text-white bg-blue p-5 lg:p-14 rounded-2xl mb-10 lg:mb-0">
                    ...
                    <div class="bg-brown rounded-2xl px-5 py-10 h-fit my-auto text-center">
                        <h5 class="text-black font-averta font-bold text-1xlg md:text-xl mb-2 lg:mb-5">Alternatively, reach out to us</h5>
                        <h5 class="text-black font-averta font-bold text-1xlg md:text-xl mb-5">Email:</h5>
                        <?php if( have_rows('contact_email') ): ?>
                            ...
                            <a class="font-averta font-light text-black text-1xlg md:text-xl block hover:underline" href="mailto:<?php echo $contactPageEmail; ?>"><?php echo $contactPageEmail; ?></a>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
                    <?php endwhile; ?>

...
<section id="whatWeDoHero" class="py-5 lg:py-14 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <!-- Breadcrumb -->
        <nav role="navigation" aria-label="Feynic navigation" class="hidden lg:block breadcrumb font-averta text-sm text-black font-semibold mb-10">
        <ol>
            <li>
    ...
    <div class="container mx-auto">
        <div class="lg:mx-10">
            <div class="lg:grid lg:grid-cols-2 gap-4">
                ...
                <!-- Partners query -->
                <div class="my-auto block lg:flex justify-end">
                    <div class="">
                        <?php
                        // The Query
                        $partnerArgs = array(
...
<!-- Case Studies -->
<section id="caseStudies" class="hidden lg:block py-14 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="mx-10">

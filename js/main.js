jQuery(document).ready(function (jQuery) {
  ...
  jQuery('#whatWeDoButton').click(function (e) {
    ...
    if (whatWeDoMobileItems.is(':visible')) {
      whatWeDoMobileItems.slideToggle();
      ; // 800ms duration with 'swing' easing
    } else {
      whatWeDoMobileItems.removeClass('hidden').hide().slideToggle();
      ; // 800ms duration with 'swing' easing
    }
  });
  jQuery('#whoWeWorkWithButton').click(function (e) {
    ...
    if (whoWeWorkWithMobileItems.is(':visible')) {
      ...
      whoWeWorkWithMobileItems.removeClass('hidden').hide().slideToggle();
      ; // 800ms duration with 'swing' easing
    }
  });

...
<section id="whatWeDoHero" class="py-5 lg:py-14 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <!-- Breadcrumb -->
        <nav role="navigation" aria-label="Feynic navigation" class="hidden lg:block breadcrumb font-averta text-sm text-black dark:text-white font-semibold mb-10">
        <ol>
            <li>
        ...
        <div class="w-full h-[430px] relative">
            <div class="pageHero_image w-full h-full rounded-2xl flex justify-center items-center" style="background-image: url('<?php echo esc_url($pageHero_url); ?>');">
                <h1 class="text-center font-averta text-white font-bold text-5xl relative z-10"><?php echo the_title(); ?></h1>
            </div>
        </div>
    </div>
</section>
...
<!-- Page Description -->
<section id="Description" class="py-5 lg:py-10 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="lg:mx-10">
            <div class="whatWeDo_heroSubtext__wrapper">
                ...
                ?>
                <h2 class="font-averta text-black dark:text-white font-normal text-1xl lg:text-2.5xl text-center"><?php echo $heroSubtext; ?></h2>
            </div>
        </div>
    </div>
</section>
...
<!-- What We Do Section -->
<section id="whatWeDo" class="py-5 lg:py-20 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="lg:mx-10">
...
<!-- Who We Work With -->
<section id="whoWeWorkWith" class="py-5 lg:py-14 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="lg:mx-10">
            <div class="lg:grid lg:grid-cols-2 gap-4">
                ...
                <?php if( have_rows('what_we_do_who_we_work_with') ): ?>
                    ...
                    <p class="text-black dark:text-white font-averta text-lg font-medium leading-snug lg:w-[80%]"><?php echo $whoWeWorkWithSubtext; ?></p>
                    <?php endwhile; ?>
                <?php endif; ?>
                </div>
                <!-- Partners query -->
                <div class="my-auto lg:flex justify-end">
                    <div class="">
                        <?php
                        // The Query
                        $partnerArgs = array(
                        ...
                        if ($partnersQuery->have_posts()) :
                            ...
                            <div class="whatWeDo_whoWeWorkWith__card w-full lg:w-[645px] h-[250px] my-5 relative rounded-2xl" style="background-image: url('<?php echo esc_url($thumbnail_url); ?>');">
...
<section id="vimeoVideo" class="py-14 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="mx-10">
            ...
            ?>
            <div class="h-[250px] lg:h-[400px] relative">
...
<!-- Case Studies -->
<section id="caseStudies" class="hidden lg:block py-24 bg-white dark:bg-zinc-800">
    <div class="container mx-auto">
        <div class="mx-10">
        ...
        <div class="mx-10">
            ...
            if ($projectsQuery->have_posts()) :
                ...
                <div class="testmionialVimeo_wrapper h-[250px] lg:h-[400px] relative">
                    ...
                    <a class="hidden lg:block flex items-center w-fit text-lg font-semibold mt-5 absolute -bottom-20" type="button" href="<?php echo get_post_type_archive_link('testimonial')?>">
